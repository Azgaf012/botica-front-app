                  ...
                  <form>
                    <div className="row mb-3">
                      <label className="col-6 form-label">
                        Motivo
                        <input type="text" name="name" placeholder="Ingrese motivo" className="form-control" />
                      </label>
                      <label className="col-6 form-label">
                        Tipo
                        <input type="text" name="surname" placeholder="Ingrese tipo" className="form-control" />
                      </label>
                    </div>
                    <div className="row mb-3">
                      <label className="col-6 form-label">
                        Cantidad
                        <input type="text" name="dni" placeholder="Ingrese cantidad" className="form-control" />
                      </label>
                    </div>
